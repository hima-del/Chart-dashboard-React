...
const radarData = {
  labels: ['Eating', 'Drinking', 'Sleeping', 'Designing', 'Coding', 'Cycling', 'Running','hello','sports','yoga'],
  datasets: [
    {
      label: 'My First dataset',
      ...
      data: [65, 59, 90, 81, 56, 55, 40,50,90],
    }
  ],
}
...
const pieData = {
   labels: [['red:300','red:300','red:300'], 'Blue', 'Yellow'],
  datasets: [
    {
      data: [300, 50, 100],
