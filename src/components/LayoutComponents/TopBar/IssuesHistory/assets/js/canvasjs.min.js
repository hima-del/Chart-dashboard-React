...
;(function() {
  ...
  function fb(k, p) {
    ...
    for (0 > r && (r += D); r < D; r++) if (r in this && this[r] === k) return r
    return -1
  }
  function u(k) {
  ...
  function hb(k) {
    if (!ib) {
      ...
      'undefined' === typeof ra.Chart.creditHref
        ? ((k.creditHref = ja('iuuqr;..b`ow`rkr/bnl.')), (k.creditText = ja('B`ow`rKR/bnl')))
        : ((p = k.updateOption('creditText')), (D = k.updateOption('creditHref')))
      if (k.creditHref && k.creditText) {
        ...
        if (0 === k.renderCount || p || D)
          k._creditLink.setAttribute('href', ''), (k._creditLink.innerHTML = '')
        k._creditLink && k.creditHref && k.creditText
          ? (k._creditLink.parentElement || k._canvasJSContainer.appendChild(k._creditLink),
            (k._creditLink.style.top = k.height - 14 + 'px'))
          : k._creditLink.parentElement && k._canvasJSContainer.removeChild(k._creditLink)
      }
    }
  }
  function ta(k, p) {
  ...
  ;(function() {
    U.fSDec = function(k) {
      for (var p = '', r = 0; r < k.length; r++)
        p += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(r))
      return p
    }
    U.obj = {
      trVs: '',
  ...
  var $a = {},
      ...
      return function(z, E, L) {
        ...
        return (L = E.replace(k, function(g) {
          switch (g) {
            ...
            case 'zzz':
              return (
                (0 < e ? '-' : '+') + $(Math.floor(Math.abs(e) / 60), 2) + $(Math.abs(e) % 60, 2)
              )
            default:
      ...
      for (O = z = Q = N = E = 0; 0 < L.length; )
        if (((p = L.pop()), '#' === p || '0' === p))
          if ((E++, E === I)) {
            var M = F,
              F = []
            if ('0' === p) for (p = I - N - (M ? M.length : 0); 0 < p; ) M.unshift('0'), p--
            for (; 0 < M.length; )
              (r = M.pop() + r), O++, 0 === O % z && Q === S && 0 < M.length && (r = H + r)
          } else
            0 < F.length ? ((r = F.pop() + r), N++, O++) : '0' === p && ((r = '0' + r), N++, O++),
    ...
    Ra = function(k) {
      ...
      k.offsetX || 0 === k.offsetX
        ...
        : ((p = k.pageX - k.target.offsetLeft), (r = k.pageY - k.target.offsetTop))
      return { x: p, y: r }
    },
    bb = !0,
  ...
  V.prototype.get = function(k) {
    ...
    if (p.hasOwnProperty(k) || (p.publicProperties && p.publicProperties.hasOwnProperty(k)))
      return this[k]
    window.console &&
  ...
  V.prototype.set = function(k, p, r) {
    ...
    if ('options' === k) this.createUserOptions(p)
      ...
      this.options._isPlaceholder && this.createUserOptions(), (this.options[k] = p)
    else {
      window.console &&
        (u.publicProperties &&
        u.publicProperties.hasOwnProperty(k) &&
      ...
      if (
        ...
        (this.options = 'undefined' === typeof k ? {} : k),
          ...
          this.optionsName
            ...
            ? ((r = p.charAt(0).toLowerCase()), 1 < p.length && (r = r.concat(p.slice(1))), (p = r))
            : (p = void 0),
          (k[p] = this.options)
  }
  ...
  Aa.prototype.setLayout = function() {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth = p.width - 4 - F * ('center' === this.horizontalAlign ? 2 : 1)),
        ...
        : 'center' === this.verticalAlign &&
          ('left' === this.horizontalAlign || 'right' === this.horizontalAlign
            ...
            : 'center' === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = p.width - 4), (H = 0.5 * p.height - 4)))
      var L
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ('top' === this.verticalAlign
            ? ((v = p.y1 + 2), (I = 'top'))
            : 'bottom' === this.verticalAlign && ((v = p.y2 - 2 - L.height), (I = 'bottom')),
          'left' === this.horizontalAlign
            ? (r = p.x1 + 2)
            : 'center' === this.horizontalAlign
  ...
  Na.Chart = (function() {
    ...
    function p(a, d) {
      ...
      if (
        ...
        this._selectedColorSet =
          'undefined' !== typeof Ba[this.colorSet] ? Ba[this.colorSet] : Ba.colorSet1
    ...
    function v(a, d) {
      for (var b = [], c, e = 0; e < a.length; e++)
        if (0 == e) b.push(a[0])
          ...
          c =
            (Math.abs((a[m].x - a[g].x) / (0 === a[m].x - a[l].x ? 0.01 : a[m].x - a[l].x)) *
              (d - 1)) /
              2 +
            1
          var w = (a[m].x - a[g].x) / c
          ...
          m = l === a.length - 1 ? l : l + 1
          c =
            (Math.abs((a[m].x - a[g].x) / (0 === a[l].x - a[g].x ? 0.01 : a[l].x - a[g].x)) *
              (d - 1)) /
              2 +
            1
          w = (a[m].x - a[g].x) / c
    ...
    function E(a, d, b, c, e, g, m, l, w, h) {
      ...
      a.beginPath()
      w && 0 < m.thickness
        ? (a.moveTo(c - s, b), a.lineTo(c - s, e), a.moveTo(d + s, b), a.lineTo(d + s, e))
        : 0 < m.thickness &&
          (a.moveTo(d, b + s), a.lineTo(c, b + s), a.moveTo(d, e - s), a.lineTo(c, e - s))
      a.stroke()
      a.restore()
    }
    ...
    p.prototype._updateOptions = function() {
      ...
      if (this.options.zoomEnabled) {
        if (!this._zoomButton) {
          ...
          O(
            ...
            function() {
              a.zoomEnabled
                ? ((a.zoomEnabled = !1), (a.panEnabled = !0), ua(a, a._zoomButton, 'zoom'))
                : ((a.zoomEnabled = !0), (a.panEnabled = !1), ua(a, a._zoomButton, 'pan'))
              a.render()
            },
            this.allDOMEventHandlers,
          )
      ...
      'none' !== this._toolBar.style.display &&
        this._zoomButton &&
        (this.panEnabled ? ua(a, a._zoomButton, 'zoom') : ua(a, a._zoomButton, 'pan'),
    ...
    p.prototype.renderElements = function() {
      ...
      this.animatedRender &&
        ...
        ((e = ta(this.width, this.height).getContext('2d')), b.push(this.renderIndexLabels(e)))
      var s = this
      if (0 < b.length)
        (s.disableToolTip = !0),
          s._animator.animate(
                ...
                (w = b[e]),
                  1 > a && 'undefined' !== typeof w.startTimePercent
                    ? a >= w.startTimePercent &&
                      w.animationCallback(
                        w.easingFunction(a - w.startTimePercent, 0, 1, 1 - w.startTimePercent),
                        w,
                      )
    ...
    p.prototype.categoriseDataSeries = function() {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (b = this.plotInfo.plotTypes[d], m = a = 0; m < b.plotUnits.length; m++)
        ...
        for (
          ...
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, m),
                d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l))
              : ((d.dataPointYPositiveSums = m), (d.dataPointYNegativeSums = l)))
    ...
    p.prototype._processMultiYPlotUnit = function(a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, m, l = !1, w = 0;
          ...
          if ('normal' === h.axisPlacement || 'xySwapped' === h.axisPlacement)
            var r = a.axisX.sessionVariables.newViewportMinimum
              ...
              t = a.axisX.sessionVariables.newViewportMaximum
                ...
                ? this.options.axisX.maximum
                : Infinity
          if ((h.dataPoints[s].x && h.dataPoints[s].x.getTime) || 'dateTime' === h.xValueType)
            l = !0
        ...
        for (
          ...
          for (w = 0; w < l.dataPoints.length; w++)
            ...
            !0 === l.dataPoints[w].isCumulativeSum
              ? ((l.dataPointEOs[w].cumulativeSumYStartValue = 0),
                ...
                (l.dataPoints[w].y = 0 === w ? 0 : l.dataPointEOs[w - 1].cumulativeSum))
              ...
              ? ((l.dataPointEOs[w].cumulativeSumYStartValue = q),
                ...
                (c = 0))
              : ((e = 'number' !== typeof l.dataPoints[w].y ? 0 : l.dataPoints[w].y),
          ...
          for (w = 0; w < l.dataPoints.length; w++)
            if (
              ...
              c < b.min && (b.min = c),
              c > b.max && (b.max = c),
              l.dataPointEOs[w].cumulativeSum < d.min && (d.min = l.dataPointEOs[w].cumulativeSum),
              l.dataPointEOs[w].cumulativeSum > d.max && (d.max = l.dataPointEOs[w].cumulativeSum),
              0 < w &&
                (a.axisX.logarithmic
                ...
                null !== e &&
                  null !== l.dataPoints[w - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e = l.dataPointEOs[w].cumulativeSum / l.dataPointEOs[w - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
    ...
    p.prototype.calculateAutoBreaks = function() {
      ...
      function b(a) {
        if (
          ...
          for (
            var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges, g, h = 0, l = 0;
            ...
            if (!(4 > m.dataPoints.length))
              for (h = 0; h < m.dataPoints.length; h++)
                (g =
                  ...
                  100),
                  (c = m.dataPoints[h].x.getTime ? m.dataPoints[h].x.getTime() : m.dataPoints[h].x),
                  (g = Math.floor((c - b) / g)),
                  c < f[g].min && (f[g].min = c),
                  c > f[g].max && (f[g].max = c)
          }
      ...
      for (var c, e = this, g = !1, m = 0; m < this._axes.length; m++)
        if (
          ...
          for (
            var l = 0;
            l <
            100 / Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10);
            l++
          )
      ...
      if (g) {
        for (m = 0; m < this.plotInfo.plotTypes.length; m++)
          for (g = this.plotInfo.plotTypes[m], l = 0; l < g.plotUnits.length; l++)
            (c = g.plotUnits[l]),
              'line' === c.type ||
              'stepLine' === c.type ||
              'spline' === c.type ||
          ...
          if (this._axes[m].dataInfo._dataRanges) {
            ...
            c =
              ((this._axes[m].dataInfo.max + 1 - w) *
                Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10)) /
              100
            ...
            if (this._axes[m].scaleBreaks.customBreaks)
              for (l = 0; l < this._axes[m].scaleBreaks.customBreaks.length; l++)
                for (c = 0; c < g.length; c++)
                  if (
                    (this._axes[m].scaleBreaks.customBreaks[l].startValue <= g[c].start &&
                      g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].endValue) ||
                    (this._axes[m].scaleBreaks.customBreaks[l].startValue <= g[c].start &&
                      g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].endValue) ||
                    (g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].startValue &&
                      this._axes[m].scaleBreaks.customBreaks[l].startValue <= g[c].end) ||
                    (g[c].start <= this._axes[m].scaleBreaks.customBreaks[l].endValue &&
                      this._axes[m].scaleBreaks.customBreaks[l].endValue <= g[c].end)
                  )
                    g.splice(c, 1), c--
            g.sort(function(a, c) {
            ...
            for (
              l = 0;
              l < Math.min(g.length, this._axes[m].scaleBreaks.maxNumberOfAutoBreaks);
              l++
            )
              (c = a(
                g[l].start,
    ...
    p.prototype.getDataPointAtXY = function(a, d, b) {
      ...
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((e = na('markerSize', c[b].dataPoint, c[b].dataSeries) || 8), c[b].distance <= e / 2)
          ) {
            d = !0
            break
          }
      ...
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(b && 1 < b.length)) {
          ...
          try {
            ...
            if ((1 < Math.abs(m) && this._lastTouchData.scroll) || (5 < Math.abs(m) && 250 > g))
      ...
      p.capturedEventParam &&
        ...
        c.hasOwnProperty(b) &&
          ('mouseup' !== b || c.chart.overlaidCanvas.releaseCapture
            ? (a.target !== c.chart.overlaidCanvas && r) || c[b].call(c.context, d.x, d.y)
    ...
    p.prototype.validateRegion = function(a, d, b, c, e) {
      ...
      for (
        ...
        (('axisX' === this._axes[q].type && g) || ('axisY' === this._axes[q].type && m)) &&
          h.push(this._axes[q])
    ...
    p.prototype.renderIndexLabels = function(a) {
        ...
        if (null !== x && '' !== x) {
          ...
          if ('stackedarea100' === s) {
            ...
            if (
              ...
              continue
          } else if (h.dataPoint.x < y.viewportMinimum || h.dataPoint.x > y.viewportMaximum)
            continue
          e = m = 2
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== t
              ? ((e = b.y1),
                ...
                0 < ma
                  ? ((n = h.point.y - w - m - c),
                    n < e &&
                      ((n = 'auto' === t ? Math.max(h.point.y, e) + m + c : e + m + c),
                      (v = n + w > h.point.y)))
                  : ((n = h.point.y + m + c),
                    n > g - w - m - c &&
                      ((n = 'auto' === t ? Math.min(h.point.y, g) - w - m - c : g - w - m - c),
                      (v = n < h.point.y))))
              : ((e = Math.max(h.bounds.y1, b.y1)),
                ...
                (c =
                  0 <= s.indexOf('range') || 'error' === s
                    ...
                    : (Math.max(h.bounds.y1, b.y1) + Math.min(h.bounds.y2, b.y2)) / 2),
                0 < ma
            ...
            0 <= s.indexOf('line') || 0 <= s.indexOf('area') || 0 <= s.indexOf('scatter')
              ? ((t = 'auto'), (e = 4))
              : 0 <= s.indexOf('stacked')
              ? 'auto' === t && (t = 'inside')
              : 'bubble' === s && (t = 'inside'),
              ...
              'inside' !== t
                ? ((m = b.x1),
                  ...
                  0 > ma
                    ? ((q = h.point.x - l - e - c),
                      q < m &&
                        ((q = 'auto' === t ? Math.max(h.point.x, m) + e + c : m + e + c),
                        (v = q + l > h.point.x)))
                    : ((q = h.point.x + e + c),
                      q > g - l - e - c &&
                        ((q = 'auto' === t ? Math.min(h.point.x, g) - l - e - c : g - l - e - c),
                        (v = q < h.point.x))))
                : ((m = Math.max(h.bounds.x1, b.x1)),
                  ...
                  (c =
                    0 <= s.indexOf('range') || 'error' === s
                      ...
                      : (Math.max(h.bounds.x1, b.x1) + Math.min(h.bounds.x2, b.x2)) / 2),
                  (q = 0 > ma ? Math.max(h.point.x, c) - l / 2 : Math.min(h.point.x, c) - l / 2),
                  (q = Math.max(q, m)))
          'vertical' === C && (n += w)
          f.x = q
          f.y = n
          ...
          p &&
            ...
            0 <= s.indexOf('bar') || ('error' === s && h.axisSwapped)
              ? d.lineTo(q + (0 < h.direction ? 0 : l), n + ('horizontal' === C ? w : -w) / 2)
              : 0 <= s.indexOf('column') || ('error' === s && !h.axisSwapped)
              ? d.lineTo(
                  q + l / 2,
                  n + ((0 < h.direction ? w : -w) + ('horizontal' === C ? w : -w)) / 2,
                )
              : d.lineTo(
                  q + l / 2,
                  n + ((n < h.point.y ? w : -w) + ('horizontal' === C ? w : -w)) / 2,
                ),
            d.stroke())
        }
      }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (h = this._indexLabels[a]),
          (f = na('indexLabelBackgroundColor', h.dataPoint, h.dataSeries)),
          (h.dataSeries.indexLabelBackgroundColor = u(f) ? (r ? 'transparent' : null) : f)
      return d
    }
            ...
            for (var u = !1, t = 0; t < s.length; t++)
              if (
                ...
                !(
                  ...
                  (C > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !u))
                ))
              )
                if ('number' !== typeof s[t].y)
                  0 < t && !(h.connectNullData || u || p) && (b.stroke(), r && c.stroke()), (u = !0)
                else {
                  ...
                  p || u
                    ? (!p && h.connectNullData
                        ? (b.setLineDash &&
                          ...
                          b.lineTo(C, x),
                          r && c.lineTo(C, x))
                        : (b.beginPath(), b.moveTo(C, x), r && (c.beginPath(), c.moveTo(C, x))),
                      (u = p = !1))
                    : (b.lineTo(C, x),
                      r && c.lineTo(C, x),
                      0 == t % 500 &&
                  ...
                  m = { x: C, y: x }
                  t < s.length - 1 &&
                    (k !== (s[t].lineColor || B) || q !== (s[t].lineDashType || h.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(C, x),
                    (k = s[t].lineColor || B),
                    ...
                    b.setLineDash &&
                      (s[t].lineDashType
                        ? ((q = s[t].lineDashType), b.setLineDash(R(q, h.lineThickness)))
          ...
          for (var b = 0; b < a.length - 3; b += 3)
            if (
              ...
              c.stroke(),
                ...
                r && (e.stroke(), e.beginPath(), e.moveTo(a[b + 3].x, a[b + 3].y))
          c.stroke()
          r && e.stroke()
        }
      }
            ...
            for (u = !1, p = 0; p < s.length; p++)
              if (
                ...
                !(
                  ...
                  (t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !u))
                ))
              )
                if ('number' !== typeof s[p].y)
                  0 < p &&
                    ...
                    (h.connectNullData
                      ? c.setLineDash &&
                        0 < x.length &&
                        (h.options.nullDataLineDashType || !s[p - 1].lineDashType) &&
                        ((x[x.length - 1].newLineDashArray = n), (q = h.nullDataLineDashType))
                      : (d(x), (x = []))),
                    (u = !0)
                else {
                  ...
                  x[x.length] = { x: t, y: u }
                  p < s.length - 1 &&
                    (k !== (s[p].lineColor || B) || q !== (s[p].lineDashType || h.lineDashType)) &&
                    ((k = s[p].lineColor || B),
                    (x[x.length - 1].newStrokeStyle = k),
                    c.setLineDash &&
                      (s[p].lineDashType
                        ? ((q = s[p].lineDashType),
                          (x[x.length - 1].newLineDashArray = R(q, h.lineThickness)))
                        : ((q = h.lineDashType), (x[x.length - 1].newLineDashArray = f))))
    ...
    p.prototype.renderColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          g > s &&
          (g = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s))
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          s < g &&
          (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, g))
        q < g && (q = g)
        q > s && (q = s)
        b.save()
          ...
          if (0 < B.length)
            for (var p = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < B.length; g++)
              if (
                ...
                !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) &&
                  'number' === typeof B[g].y)
              ) {
                ...
                ;(B[g].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: B[g],
                    dataSeries: f,
                    point: { x: m + (k - m) / 2, y: 0 > B[g].y === a.axisY.reversed ? l : t },
                    direction: 0 > B[g].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: m, y1: Math.min(l, t), x2: k, y2: Math.max(l, t) },
                    color: c,
                  })
              }
        }
    ...
    p.prototype.renderStackedColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          h > s &&
          (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s))
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          s < h &&
          (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h))
        f < h && (f = h)
        f > s && (f = s)
        b.save()
        r && this._eventManager.ghostCtx.save()
              ...
              if (
                ...
                ;(t[h].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    bounds: { x1: x, y1: Math.min(q, y), x2: v, y2: Math.max(q, y) },
                    color: c,
                  })
              }
          }
              ...
              if (
                ...
                if (
                  ...
                  (A = 'undefined' !== typeof m[c] ? m[c] : 0),
                    (y = q + A),
                    (q = n + A),
                    a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y2 - y) && (y = e.y2),
                    (m[c] = A + (y - q))
              ...
              if (
                ...
                ;(B[g].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 0 > B[g].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(t, m), y1: l, x2: Math.max(t, m), y2: p },
                    color: c,
                  })
              }
          }
    ...
    p.prototype.renderStackedBar = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          h > q &&
          (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, q))
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          q < h &&
          (q = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h))
        f < h && (f = h)
        f > q && (f = q)
        b.save()
        r && this._eventManager.ghostCtx.save()
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (l[c] = t[h].y + (l[c] ? l[c] : 0)),
                    0 < l[c] &&
                      ((y = g[c] ? g[c] : n), (g[c] = s = a.axisY.convertValueToPixel(l[c])))
                else if (
                  a.axisY.scaleBreaks &&
                  0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  0 >= t[h].y
                ...
                ;(t[h].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(y, s), y1: x, x2: Math.max(y, s), y2: v },
                    color: c,
                  })
              }
          }
              ...
              if (
                ...
                if (
                  ...
                  (A = m[c] ? m[c] : 0),
                    (x = s - A),
                    (s = n - A),
                    a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.x1 - x) && (x = e.x1),
                    (m[c] = A + (s - x))
                c = t[h].color ? t[h].color : p._colorSet[h % p._colorSet.length]
                ...
                ;(t[h].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(x, s), y1: v, x2: Math.max(x, s), y2: y },
                    color: c,
                  })
              }
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          var f = a.dataSeriesIndexes[n],
            ...
            p = B.dataPoints,
            h = B.id
          this._eventManager.objectMap[h] = { objectType: 'dataSeries', dataSeriesIndex: f }
          h = N(h)
          m.fillStyle = h
          h = []
          d = !0
            ...
            for (var da = !0; k < p.length; k++)
              if (
                ...
                !(
                  ...
                  (x > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !da))
                ))
              )
                  ...
                  d || da
                    ? (!d && B.connectNullData
                        ...
                        : (g.beginPath(),
                          ...
                          (A = { x: t, y: u })),
                      (da = d = !1))
                    : (g.lineTo(t, u), r && m.lineTo(t, u), 0 == k % 250 && c())
                  q = { x: t, y: u }
                  k < p.length - 1 &&
                    (T !== (p[k].lineColor || aa) || b !== (p[k].lineDashType || B.lineDashType)) &&
                    (c(),
                    (T = p[k].lineColor || aa),
                    (g.strokeStyle = T),
                    g.setLineDash &&
                      (p[k].lineDashType
                        ? ((b = p[k].lineDashType), g.setLineDash(R(b, B.lineThickness)))
            ...
            for (k = !1; f < n.length; f++)
              if (
                ...
                !(
                  ...
                  (B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !k))
                ))
              )
                if ('number' !== typeof n[f].y)
                  0 < f &&
                    ...
                    (q.connectNullData
                      ? c.setLineDash &&
                        ...
                        ((x[x.length - 1].newLineDashArray = aa), (z = q.nullDataLineDashType))
                      : (d(), (x = []))),
                    (k = !0)
                else {
                  ...
                  x[x.length] = { x: B, y: k }
                  f < n.length - 1 &&
                    (A !== (n[f].lineColor || y) || z !== (n[f].lineDashType || q.lineDashType)) &&
                    ((A = n[f].lineColor || y),
                    (x[x.length - 1].newStrokeStyle = A),
                    c.setLineDash &&
                      (n[f].lineDashType
                        ? ((z = n[f].lineDashType),
                          (x[x.length - 1].newLineDashArray = R(z, q.lineThickness)))
                        : ((z = q.lineDashType), (x[x.length - 1].newLineDashArray = T))))
          ...
          if (0 < k.length) {
            ...
            for (; p < k.length; p++)
              if (
                ...
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !b))
                ))
              ) {
                var Z = u
                'number' !== typeof k[p].y
                  ...
                  : ((t = a.axisX.convertValueToPixel(x)),
                    ...
                    p < k.length - 1 &&
                      ...
                      g.setLineDash &&
                        (k[p].lineDashType
                          ? ((Y = k[p].lineDashType), g.setLineDash(R(Y, B.lineThickness)))
            ...
            for (var da = !0, n = 0; n < s.length; n++) {
              ...
              if (
                !(
                  ...
                  (g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da))
                )
              )
                if ('number' !== typeof Z.y) A.connectNullData || da || C || d(), (da = !0)
                  ...
                  C || da
                    ? (!C && A.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(f, k),
                          r && u.lineTo(f, k))
                        : (c.beginPath(), c.moveTo(f, k), r && (u.beginPath(), u.moveTo(f, k))),
                      (da = C = !1))
                    : (c.lineTo(f, k),
                      r && u.lineTo(f, k),
                      0 == n % 250 &&
                        (d(), c.moveTo(f, k), r && u.moveTo(f, k), h.push({ x: f, y: p - oa })))
                  t = { x: f, y: k }
                  n < z.length - 1 &&
                    (T !== (z[n].lineColor || aa) || x !== (z[n].lineDashType || A.lineDashType)) &&
                    (d(),
                    c.beginPath(),
                    c.moveTo(f, k),
                    h.push({ x: f, y: p - oa }),
                  ...
                  0 <= A.dataPointIndexes[g] &&
                    ...
                    ((oa = A.getMarkerProperties(A.dataPointIndexes[g], f, k, c)),
                    m.push(oa),
                    (g = N(la)),
                    r &&
                      m.push({
                  ...
                  u || da
                    ? (!u && A.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(f, k),
                          r && x.lineTo(f, k))
                        : (c.beginPath(), c.moveTo(f, k), r && (x.beginPath(), x.moveTo(f, k))),
                      (da = u = !1))
                    : (c.lineTo(f, k),
                      r && x.lineTo(f, k),
                      0 == n % 250 &&
                        (d(), c.moveTo(f, k), r && x.moveTo(f, k), h.push({ x: f, y: C - la })))
                  p = { x: f, y: k }
                  n < z.length - 1 &&
                    (T !== (z[n].lineColor || aa) || t !== (z[n].lineDashType || A.lineDashType)) &&
                    (d(),
                    c.beginPath(),
                    c.moveTo(f, k),
                    h.push({ x: f, y: C - la }),
    ...
    p.prototype.renderBubble = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = -Infinity, w = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
          for (
            var s = a.dataSeriesIndexes[h], q = this.data[s], n = q.dataPoints, f = 0, e = 0;
            e < n.length;
            e++
          )
        ...
        for (
          var k = 25 * Math.PI,
            p = Math.max(Math.pow((0.25 * Math.min(c.height, c.width)) / 2, 2) * Math.PI, k),
            h = 0;
          h < a.dataSeriesIndexes.length;
          h++
        )
              ...
              if (
                ...
                var f = n[e].z,
                  u =
                    2 *
                    Math.max(
                      Math.sqrt((l === w ? p / 2 : k + ((p - k) / (l - w)) * (f - w)) / Math.PI) <<
                        0,
                      1,
                    ),
          ...
          if (0 < s.length) {
            ...
            for (var q = 0, n = 0, e = 0; e < s.length; e++)
              if (
                ...
                b.globalAlpha = 1
                ;(Math.sqrt((q - g) * (q - g) + (n - m) * (n - m)) < Math.min(f.size, 5) &&
                  s.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                  ((q = h.dataPointIds[e]),
              ...
              if (
                ...
                'candlestick' === t.type
                  ? (b.moveTo(w - D, s),
                    ...
                    r &&
                      ...
                      c.lineTo(w - D, q),
                      c.stroke(),
                      ea(c, z, Math.min(h, n), y, Math.max(h, n), e, 0, null, !1, !1, !1, !1)))
                  : 'ohlc' === t.type &&
                    (b.moveTo(w - D, s),
                    b.lineTo(w - D, q),
                    b.stroke(),
                ...
                ;(C[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 1,
                    bounds: { x1: z, y1: Math.min(s, q), x2: y, y2: Math.max(s, q) },
                    color: e,
                  })
              }
        }
    ...
    p.prototype.renderBoxAndWhisker = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          e > m &&
          (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m))
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          m < e &&
          (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e))
        k < e && (k = e)
        k > m && (k = m)
        b.save()
        r && c.save()
              ...
              if (
                ...
                r &&
                  ...
                  0 < la &&
                    ...
                    c.lineTo(l - aa - G, s),
                    c.stroke()),
                  ea(c, y, Math.max(h, s), A, Math.min(h, s), e, 0, null, !1, !1, !1, !1),
                  0 < Y &&
                    (c.beginPath(),
                    (c.lineWidth = Y),
                    c.moveTo(l + da / 2, q - Z),
                ...
                ;(x[m].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 1,
                    bounds: { x1: y, y1: Math.min(w, q), x2: A, y2: Math.max(w, q) },
                    color: e,
                  })
              }
        }
    ...
    p.prototype.renderRangeColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          g > m &&
          (g = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m))
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          m < g &&
          (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, g))
        h < g && (h = g)
        h > m && (h = m)
        b.save()
        r && this._eventManager.ghostCtx.save()
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          var q = a.dataSeriesIndexes[s],
            ...
            f = n.dataPoints
          if (0 < f.length)
            for (var k = 5 < h && n.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
              if (
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    dataSeries: n,
                    indexKeyword: 0,
                    point: { x: p + (v - p) / 2, y: f[g].y[1] >= f[g].y[0] ? l : m },
                    direction: f[g].y[1] >= f[g].y[0] ? -1 : 1,
                    bounds: { x1: p, y1: Math.min(m, l), x2: v, y2: Math.max(m, l) },
                    color: c,
                  }),
                    this._indexLabels.push({
                      chartType: 'rangeColumn',
                      ...
                      dataSeries: n,
                      indexKeyword: 1,
                      point: { x: p + (v - p) / 2, y: f[g].y[1] >= f[g].y[0] ? m : l },
                      direction: f[g].y[1] >= f[g].y[0] ? 1 : -1,
                      bounds: { x1: p, y1: Math.min(m, l), x2: v, y2: Math.max(m, l) },
                      color: c,
                    })
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          var x = a.dataSeriesIndexes[C],
            ...
            A = u(z._linkedSeries)
              ? !1
              : z._linkedSeries.type.match(/(bar|column)/gi) && z._linkedSeries.visible
              ? !0
              : !1,
            D = 0
          if (A)
          ...
          l = this.options.dataPointMaxWidth
            ...
            ? this.dataPointWidth
            : c
            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (A ? v : 1))) << 0
            : 0.3 * this.width
          g &&
            (l = this.options.dataPointMaxWidth
              ? this.dataPointMaxWidth
          ...
          this.dataPointMaxWidth &&
            e > l &&
            (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l))
          !this.dataPointMaxWidth &&
            this.dataPointMinWidth &&
            l < e &&
            (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e))
          t < e && (t = e)
          t > l && (t = l)
          if (0 < y.length)
            for (var aa = z._colorSet, l = 0; l < y.length; l++) {
              ...
              var Y = {
                ...
                dashType: y[l].stemDashType ? y[l].stemDashType : z.stemDashType,
              }
              Y.thickness =
              ...
              if (
                !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) &&
                !u(y[l].y) &&
                y[l].y.length &&
              ...
              if (
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    dataSeries: f,
                    indexKeyword: 0,
                    point: { x: k[g].y[1] >= k[g].y[0] ? m : l, y: w + (v - w) / 2 },
                    direction: k[g].y[1] >= k[g].y[0] ? -1 : 1,
                    bounds: { x1: Math.min(m, l), y1: w, x2: Math.max(m, l), y2: v },
                    color: c,
                  }),
                    this._indexLabels.push({
                      chartType: 'rangeBar',
                      ...
                      dataSeries: f,
                      indexKeyword: 1,
                      point: { x: k[g].y[1] >= k[g].y[0] ? l : m, y: w + (v - w) / 2 },
                      direction: k[g].y[1] >= k[g].y[0] ? 1 : -1,
                      bounds: { x1: Math.min(m, l), y1: w, x2: Math.max(m, l), y2: v },
                      color: c,
                    })
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          var w = [],
            ...
            q = s.dataPoints,
            g = s.id
          this._eventManager.objectMap[g] = { objectType: 'dataSeries', dataSeriesIndex: h }
          g = N(g)
          e.fillStyle = g
          var g = [],
            n = !0,
          ...
          if (0 < q.length) {
            ...
            for (var T = !0; f < q.length; f++)
              if (
                ...
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  (t > a.axisX.dataInfo.viewPortMax && (!s.connectNullData || !T))
                ))
              )
                if (
                  null !== q[f].y &&
                  ...
                  f < q.length - 1 &&
                    (y !== (q[f].lineColor || v) || A !== (q[f].lineDashType || s.lineDashType)) &&
                    (d(),
                    (y = q[f].lineColor || v),
                    ...
                    c.setLineDash &&
                      (q[f].lineDashType
                        ? ((A = q[f].lineDashType),
                          (w[w.length - 1].newLineDashArray = R(A, s.lineThickness)),
            ...
            for (f = !1; q < k.length; q++)
              if (
                ...
                !(
                  ...
                  (n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !f))
                ))
              )
                if (
                  null !== k[q].y &&
                  ...
                  z[z.length] = { x: n, y: p }
                  q < k.length - 1 &&
                    (x !== (k[q].lineColor || C) || F !== (k[q].lineDashType || h.lineDashType)) &&
                    ((x = k[q].lineColor || C),
                    (u[u.length - 1].newStrokeStyle = x),
                    c.setLineDash &&
                      (k[q].lineDashType
                        ? ((F = k[q].lineDashType),
                          (u[u.length - 1].newLineDashArray = R(F, h.lineThickness)))
                        : ((F = h.lineDashType), (u[u.length - 1].newLineDashArray = y))))
                  ...
                  0 < q &&
                    ...
                    (h.connectNullData
                      ? c.setLineDash &&
                        0 < u.length &&
                        (h.options.nullDataLineDashType || !k[q - 1].lineDashType) &&
                        ((u[u.length - 1].newLineDashArray = A), (F = h.nullDataLineDashType))
                      : (d(y, C), (u = []), (z = []))),
                    (f = !0)
            d(y, C)
            ia.drawMarkers(g)
    ...
    p.prototype.renderWaterfall = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          m > k &&
          (m = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, k))
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          k < m &&
          (k = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, m))
        n < m && (n = m)
        n > k && (n = k)
        b.save()
        r && this._eventManager.ghostCtx.save()
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < v.length)
            for (
              var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, m = 0;
              m < v.length;
              m++
            )
              if (
                (v[m].getTime ? (s = v[m].x.getTime()) : (s = v[m].x), 'number' !== typeof v[m].y)
              ) {
                ...
                k =
                  0 === u.dataPointEOs[m].cumulativeSum
                    ? q
                    : a.axisY.convertValueToPixel(u.dataPointEOs[m].cumulativeSum)
                h =
                  0 === u.dataPointEOs[m].cumulativeSumYStartValue
                    ? q
                    : a.axisY.convertValueToPixel(u.dataPointEOs[m].cumulativeSumYStartValue)
                l = a.axisX.reversed
                  ? (l +
                ...
                Y =
                  ...
                  ('undefined' !== typeof v[m].isCumulativeSum && !0 === v[m].isCumulativeSum)
                    ? 0 < v[m].y
                      ? k
                      : h
                    : 0 < v[m].y
                ...
                0 < m &&
                  ...
                  b.lineTo(T, Y - C),
                  0 < t && b.stroke(),
                  r && (c.beginPath(), c.moveTo(y, A - C), c.lineTo(T, Y - C), 0 < t && c.stroke()))
                z = !1
                y = F
                A = 0 < v[m].y ? k : h
                T = v[m].lineDashType
                ...
                ;(v[m].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    bounds: { x1: l, y1: Math.min(k, h), x2: F, y2: Math.max(k, h) },
                    color: e,
                  })
              }
        }
    ...
    p.prototype.renderPie = function(a) {
        ...
        if (h && s) {
          for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
            ...
            m.indexLabelMaxWidth = g.indexLabelMaxWidth
              ...
              : 0.33 * n.width
            m.indexLabelWrap =
              'undefined' !== typeof g.indexLabelWrap ? g.indexLabelWrap : h.indexLabelWrap
            m.startAngle =
              0 === d ? (h.startAngle ? (h.startAngle / 180) * Math.PI : 0) : f[d - 1].endAngle
          ...
          if (e > c) {
            ...
            if (s[b].exploded) {
              if (
                ...
                (f[b].center.x = x.x + d * a), (f[b].center.y = x.y + g * a), (m = !0)
            } else if (0 < Math.abs(f[b].center.x - x.x) || 0 < Math.abs(f[b].center.y - x.y))
              (f[b].center.x = x.x + d * (1 - a)), (f[b].center.y = x.y + g * (1 - a)), (m = !0)
            m &&
              ((d = {}),
              (d.dataSeries = h),
          ...
          (c = f[b]),
            c.indexLabelText &&
              ...
              'inside' !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(R(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                a.beginPath(),
                a.moveTo(e, d),
      ...
      function g(a, b, d) {
        ...
        if (0 <= a && a < s.length) {
          var n = f[a]
          if ((0 > b && n.indexLabelTextBlock.y < h) || (0 < b && n.indexLabelTextBlock.y > l))
            return 0
          var k = 0,
            q = 0,
            q = (k = k = 0)
          0 > b
            ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > h &&
              n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b < h &&
              (b = -(h - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b)))
            : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < h &&
              n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b > l &&
              (b = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b - l)
            ...
            ? ((l = 'right' === n.hemisphere ? q : k),
              ...
              null !== l &&
                ...
                (b =
                  ...
                  (f[l].indexLabelTextBlock.y + f[l].indexLabelTextBlock.height / 2)),
                b - q < p &&
                  ((h = -q),
                  (l = g(l, h, d + 1)),
                  +l.toFixed(C) > +h.toFixed(C) && (m = b > p ? -(b - p) : -(q - (l - h))))))
            : 0 < b &&
              ...
              null !== l &&
                ...
                b - q < p &&
                  ((h = q),
                  (l = g(l, h, d + 1)),
                  +l.toFixed(C) < +h.toFixed(C) && (m = b > p ? b - p : q - (h - l)))))
          m &&
            ...
            n.midAngle > Math.PI / 2 - t && n.midAngle < Math.PI / 2 + t
              ? ((h = (a - 1 + f.length) % f.length),
                ...
                'left' === n.hemisphere && 'right' === h.hemisphere && b > h.indexLabelTextBlock.x
              ...
              : n.midAngle > (3 * Math.PI) / 2 - t &&
                ...
                (h = f[h]),
                (a = f[(a + 1 + f.length) % f.length]),
                'right' === n.hemisphere && 'left' === h.hemisphere && b < h.indexLabelTextBlock.x
                  ? (b = h.indexLabelTextBlock.x + 15)
                  : 'left' === n.hemisphere &&
                    'right' === a.hemisphere &&
                    b > a.indexLabelTextBlock.x &&
        ...
        for (var b = (a = 0), d = 0, m = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                ...
                if (0 > z) {
                  for (var E = (u = 0), H = 0; H < s.length; H++)
                    H !== a &&
                      ...
                      (f[H].indexLabelTextBlock.y < l.indexLabelTextBlock.y ? u++ : E++)
                  u = (z / (u + E || 1)) * E
                  var E = -1 * (z - u),
                    I = (H = 0)
                  'right' === l.hemisphere
          ...
          for (a = 0; a < s.length; a++)
            if (
              ...
              (y = y = 0),
                'right' === l.hemisphere
                  ? ((y = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + q)),
                    (y *= -1))
                  : (y = n.x1 - (l.indexLabelTextBlock.x - l.indexLabelTextBlock.width - q)),
                0 < y &&
                  (!m &&
                    l.indexLabelText &&
                    ((u =
                    ...
                    0.3 * l.indexLabelTextBlock.maxWidth < u &&
                      (l.indexLabelTextBlock.x -= 'right' === l.hemisphere ? 2 : -2)),
                  Math.abs(l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - x.y) < A ||
                    Math.abs(l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 - x.y) <
                      A) &&
                ...
                0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI
                  ? ((y = n.y2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + 5)),
                    (y *= -1))
                  : (y = n.y1 - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - 5)),
                0 < y &&
                  (!m &&
                    l.indexLabelText &&
                    ((u = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1),
                    0 === g(a, y * u) && g(a, 2 * u)),
              ...
              if (((g = !1), (t = f[l]), t.indexLabelText)) {
                ...
                if (null !== m) {
                  ...
                  if ((n = 0 > z)) {
                    ...
                    var k = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
      ...
      function l() {
        ...
        k.title &&
          (k.title.dockInsidePlotArea ||
            ('center' === k.title.horizontalAlign && 'center' === k.title.verticalAlign)) &&
          k.title.render()
        if (k.subtitles)
        ...
        k.legend &&
          (k.legend.dockInsidePlotArea ||
            ('center' === k.legend.horizontalAlign && 'center' === k.legend.verticalAlign)) &&
    ...
    p.prototype.renderFunnel = function(a) {
      ...
      function b() {
        ...
        if (0 === g) return -1
        for (var m = (e[0] = 0), h = 0, n, k, b = b - a, m = !1, l = 0; l < C.length; l++)
      ...
      function c() {
        if (t && C) {
          for (
            ...
            (w = P[y]),
              (w = 'undefined' !== typeof w.x5 ? (w.y2 + w.y4) / 2 : (w.y2 + w.y3) / 2),
              (w = f(w).x2 + 1),
              (p[y] = L - w - S)
          w = 0.5 * S
          ...
          for (d = 0; d < P.length; d++)
            0 == J[d].textBlock.text.length
              ...
              : ((a = P[d]),
                ...
                (e = J[d].width),
                b >= c
                  ? ((b = d != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2),
                    (c = d != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2),
                    (J[d].textBlock.x = b),
                    (J[d].textBlock.y = c))
                  : (J[d].isDirty = !0))
      }
      ...
      function l(a, b) {
        return (
          ...
          (0 > a ? (t.reversed ? wa - D : pa - D) : J[a].textBlock.y + J[a].height + ga)
        )
      }
      function k(a, b, c) {
        var d,
        ...
        for (var b, c, d, e, g = 0; g < P.length; g++)
          (e = 1 === J[g].lineThickness % 2 ? 0.5 : 0),
            ...
            J[g].isDirty ||
              ...
              a.setLineDash && a.setLineDash(R(J[g].lineDashType, J[g].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke())
      ...
      function v(a) {
        ...
        z.legend &&
          (z.legend.dockInsidePlotArea ||
            ('center' === z.legend.horizontalAlign && 'center' === z.legend.verticalAlign)) &&
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== C.length) {
          ...
          'funnel' === t.type
            ? ((N = u(t.options.neckHeight) ? 0.35 * F : t.neckHeight),
              ...
              N > F ? (N = F) : 0 >= N && (N = 0),
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : 'pyramid' === t.type && ((G = N = 0), (t.reversed = t.reversed ? !1 : !0))
          var y = I + a / 2,
            $ = I,
            V = I + a,
            pa = t.reversed ? Z : O,
          ...
          if (-1 !== I) {
            if (t.reversed) for (E.push(X), G = I.length - 1; 0 < G; G--) (X += I[G]), E.push(X)
            else for (G = 0; G < I.length; G++) (X += I[G]), E.push(X)
            if (t.reversed)
              for (G = 0; G < I.length; G++)
                E[G] < Da
                  ? (a.push(K), y.push(ea), (fa = G))
                  : (a.push((E[G] - pa + ba * $) / ba), y.push((E[G] - pa + ha * V) / ha))
            else
              for (G = 0; G < I.length; G++)
                E[G] < Da
                  ? (a.push((E[G] - pa + ba * $) / ba), y.push((E[G] - pa + ha * V) / ha), (fa = G))
                  : (a.push(K), y.push(ea))
            ...
            for (G = 0; G < P.length; G++) (A = P[G]), ra(Q, A, t.fillOpacity), ia.push(A.y1)
            v(Q)
            H &&
              t.visible &&
            ...
            this.funnelPyramidClickHandler = function(a) {
              ...
              if (
                ...
                !z.isAnimating &&
                (u(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                ((b = t.reversed ? C.length - 1 - a.dataPointIndex : a.dataPointIndex), 0 <= b)
              ) {
                a = b
                if ('funnel' === t.type || 'pyramid' === t.type)
                  t.reversed
                    ? (C[C.length - 1 - a].exploded = C[C.length - 1 - a].exploded ? !1 : !0)
    ...
    p.prototype.replaceKeywordsWithValue = function(a, d, b, c, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace(
            '#total',
            ba(l, b.yValueFormatString ? b.yValueFormatString : '#,##0.########', g._cultureInfo),
          )
    ...
    H.prototype.setLayout = function() {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ((this.orientation = 'horizontal'),
          ...
          (m = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height))
        : 'center' === this.verticalAlign &&
            ...
            var n = (q.legendMarkerType = q.legendMarkerType
                ...
                ? 'error' === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : F.getDefaultLegendMarker(q._linkedSeries.type)
            ...
            for (var z = 0; z < q.dataPoints.length; z++) {
              var x = q.dataPoints[z],
                ...
                p = x.legendMarkerColor
                  ...
                  : q.color
                  ? q.color
                  : q._colorSet[z % q._colorSet.length],
              ...
              ;(x.showInLegend || (q.showInLegend && !1 !== x.showInLegend)) && k.push(n)
            }
      }
          ...
          if (!(0 >= m || 'undefined' === typeof m || 0 >= v || 'undefined' === typeof v)) {
            if ('horizontal' === this.orientation) {
              ...
              if (
                ...
                (q = { items: [], width: 0 }), h.push(q), (this.height += f), (f = 0)
                  ...
                  (n.textBlock.width =
                    ...
                    (r +
                      ...
                      'stepLine' === n.chartType
                        ? 2 * 0.1 * this.lineHeight
                        : 0))),
                this.height < m - this.lineHeight
                  ? ((q = { items: [], width: 0 }), h.push(q))
                  : ((q = h[z]), (z = (z + 1) % h.length)),
      ...
      this.rows = h
      0 < k.length &&
        a.layoutManager.registerSpace(b, { width: this.width + 2 + 2, height: this.height + 5 + 5 })
      ...
      for (var l = 0, k = 0; k < m.length; k++) {
        for (var h = m[k], s = 0, q = 0; q < h.items.length; q++) {
          ...
          this.ghostCtx.fillRect(
            ...
            n.textBlock.x + n.textBlock.width - u,
            n.textBlock.height,
          )
    ...
    F.prototype.getDataPointAtX = function(a, d) {
      ...
      'none' !== this.chart.plotInfo.axisPlacement &&
        (this.axisX.logarithmic
          ? ((s = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
            (s =
              1 < s
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / s) * Math.log(a / this.dataPoints[0].x)) >>
                        0,
                      0,
                    ),
                ...
                : 0))
          : ((s = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (s =
              0 < s
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / s) * (a - this.dataPoints[0].x)) >> 0,
                      0,
                    ),
                    this.dataPoints.length,
                  )
      ...
      for (;;) {
        ...
        } else if (0 > s - e && s + e >= this.dataPoints.length) break
        ;-1 === m ? (e++, (m = 1)) : (m = -1)
      }
        ...
        if (0 <= g && g < this.dataPoints.length) {
          ...
          if (n) {
            switch (this.type) {
              ...
              case 'doughnut':
                u = n.center
                r = 'doughnut' === this.type ? n.percentInnerRadius * n.radius : 0
                p = Math.sqrt(Math.pow(u.x - a, 2) + Math.pow(u.y - d, 2))
                p < n.radius &&
                  p > r &&
                  ((p = Math.atan2(d - u.y, a - u.x)),
                  0 > p && (p += 2 * Math.PI),
                  (p = Number(((((180 * (p / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                  (u = Number(
                    ((((180 * (n.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12),
                  )),
                  (r = Number(((((180 * (n.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                  0 === r && 1 < n.endAngle && (r = 360),
                  u >= r && 0 !== f.y && ((r += 360), p < u && (p += 360)),
                  p > u &&
                    p < r &&
    ...
    z.prototype.createLabels = function() {
            ...
            if (((b = this.logLabelValues[c]), b < this.viewportMinimum)) c++
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[p]
                  : ba(p, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ka(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: g,
        ...
        for (
          ...
          a ||
            ((a = this.labelFormatter
              ...
              : 'axisX' === this.type && this.labels[p]
              ? this.labels[p]
              : Ca(p, this.valueFormatString, this.chart._cultureInfo)),
            (a = new ka(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: g,
            ...
            for (
              ...
              if (!this._labels[b].breaksLabelType) {
                ...
                c =
                  ...
                  (m - a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                if (
                  ...
                  if (
                    ...
                    (p =
                      (h - (k + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) /
                      Math.sin((Math.PI / 180) * Math.abs(-25))),
                    !u(this.options.labelWrap))
                  )
                    this.labelWrap
                      ? u(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), p)),
                          (this.sessionVariables.labelWrap = this.labelWrap),
                          (B.width + d.width) >> 0 > 2 * g &&
                    ...
                    if (u(this.options.labelWrap))
                      if (!u(this.options.labelMaxWidth))
                        ...
                        if (((c = (B.width + d.width) >> 0), (f = this.labelFontSize), n < g))
                          ...
                          v === b &&
                          ((0 === v &&
                            n + this._labels[v + 1].textBlock.measureText().width - 2 * g > q) ||
                          ...
                          (q =
                            0 === v
                              ? n + this._labels[v + 1].textBlock.measureText().width - 2 * g
                              : n + this._labels[v - 1].textBlock.measureText().width - 2 * g),
                            (this.sessionVariables.labelFontSize = u(this.options.labelFontSize)
                              ? f
                              : this.options.labelFontSize),
                  ...
                  (p =
                    0 != this.labelAngle
                      ? (h -
                        ...
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : g),
                  (this.sessionVariables.labelMaxHeight = m = this.labelWrap
                    ? (h - p * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                      Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                    : 1.5 * this.labelFontSize),
                  u(this.options.labelWrap))
                    ? u(this.options.labelWrap) &&
                      (this.labelWrap && !u(this.options.labelMaxWidth)
                        ...
                        : ((this.sessionVariables.labelAngle = this.labelAngle),
                          (this.sessionVariables.labelMaxWidth = p),
                          (this.sessionVariables.labelMaxHeight = c < 0.9 * l ? 0.9 * l : c),
                          (this.sessionVariables.labelWrap = this.labelWrap)))
                  ...
                  : ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxWidth =
                      0 === this.labelAngle
                        ? g
                        : Math.min(
                            (c - m * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                              Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)),
                            m,
                          )),
                    u(this.options.labelWrap))
                  ? u(this.options.labelWrap) &&
                    (this.labelWrap && !u(this.options.labelMaxWidth)
                      ...
                      : ((this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth
                          ? this.options.labelMaxWidth
                          : g),
                        (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : c),
                        u(this.options.labelMaxWidth) &&
                          (this.sessionVariables.labelAngle = this.labelAngle)))
                  : this.options.labelWrap
                  ? ((this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : c),
      ...
      for (b = 0; b < this.stripLines.length; b++) {
          ...
          (m =
            ...
            u(g.labelBackgroundColor) &&
              (u(g.startValue) && 0 !== g.startValue
                ? (g.labelBackgroundColor = r ? 'transparent' : null)
        ...
        a = new ka(this.ctx, {
          ...
          maxWidth: g.options.labelMaxWidth ? g.options.labelMaxWidth : m,
          maxHeight: z,
          angle: this.labelAngle,
    ...
    z.setLayout = function(a, d, b, c, e, g) {
      ...
      for (f = 0; f < n.length; f++)
        if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length)
          for (
            var r = n[f].scaleBreaks._appliedBreaks, v = 0;
            v < r.length && !(r[v].startValue > n[f].viewportMaximum);
            v++
          )
            r[v].endValue < n[f].viewportMinimum ||
              (u(n[f].scaleBreaks.firstBreakIndex) && (n[f].scaleBreaks.firstBreakIndex = v),
              r[v].startValue >= n[f].viewPortMinimum && (n[f].scaleBreaks.lastBreakIndex = v))
      for (
        var z = (v = 0),
          t = 0,
          C = 0,
        ...
        n[f] &&
          n[f].title &&
          (n[f]._titleTextBlock = new ka(n[f].ctx, {
            text: n[f].title,
            horizontalAlign: 'center',
        ...
        for (var C = [], x = [], D = [], y = [], M = [], N = [], O = [], Q = []; 4 > v; ) {
          ...
          if (b && 0 < b.length)
            for (D = [], f = P = 0; f < b.length; f++)
              D.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateWidth() : 0)),
                (P += D[f]),
            ...
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (z =
                    h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                    (h.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                  (t =
                    l.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(l.textBlock.angle)) +
                ...
                !a[f] ||
                  ...
                  ((l = 0),
                  0 < a[f].labelAngle
                    ? E + t > k && (l += 0 < a[f].labelAngle ? E + t - k - ba : 0)
                    : 0 > a[f].labelAngle
                    ? A - z < m &&
                      A - z < a[f].viewportMinimum &&
                      (F = m - (K + a[f].tickLength + D + A - z + a[f].labelFontSize / 2))
                    : 0 === a[f].labelAngle &&
                      (E + t > k && (l = E + t / 2 - k - ba),
                      A - z < m &&
                        A - z < a[f].viewportMinimum &&
                        (F = m - K - a[f].tickLength - D - A + z / 2)),
                ...
                (l = Math.round(g.y2 - V - e + G)),
                (h = Math.round(g.y2)),
                (a[f].lineCoordinates.x2 = k),
                (a[f].lineCoordinates.width = k - m),
                (a[f].lineCoordinates.y1 = l),
                (a[f].lineCoordinates.y2 = l),
                (a[f].bounds = {
                  x1: m,
                  y1: l,
                  x2: k,
          ...
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              (d[f].lineCoordinates.x1 = Math.round(g.x1 + P + K)),
                (d[f].lineCoordinates.x2 = Math.round(
                  g.x2 - ba - $ > p.width - q ? p.width - q : g.x2 - ba - $,
                )),
                (d[f].lineCoordinates.width = Math.abs(k - m)),
                d[f]._labels &&
                  ...
                  (t =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                p.panEnabled
                  ? (X = p.sessionVariables.axisX2.height)
                  : (p.sessionVariables.axisX2.height = X),
                (l = Math.round(g.y1)),
                (h = Math.round(g.y2 + d[f].margin)),
                (d[f].lineCoordinates.y1 = l + X + W - R),
                (d[f].lineCoordinates.y2 = l),
                (d[f].bounds = {
                  x1: m,
                  y1: l + (X + W - x[f] - R),
                  x2: k,
                ...
                b[f] &&
                  ...
                  (K =
                    b[f]._labels && 0 < b[f]._labels.length
                      ...
                      : q),
                  (l = Math.round(g.y1 + X + W < Math.max(K, q) ? Math.max(K, q) : g.y1 + X + W)),
                  (k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                  (K =
                    0 < a.length
                      ? 0
                      : b[f]._labels && 0 < b[f]._labels.length
          ...
          if (c && 0 < c.length)
            for (f = 0; f < c.length; f++)
              c[f] &&
                ((m = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2)),
                (k = Math.round(m)),
                (K =
                ...
                a[f]._labels &&
                  ...
                  (m =
                    a[f]._labels[a[f]._labels.length - ('dateTime' === a[f].valueType ? 2 : 1)]
                      .position),
                  (m = a[f].getApparentDifference(a[f].viewportMinimum, m)),
                  (E = a[f].logarithmic
                    ? (1 < m
                        ? (Math.log(m) / a[f].conversionParameters.lnLogarithmBase) *
                          Math.abs(a[f].conversionParameters.pixelPerUnit)
                        : 0) + a[f].lineCoordinates.x1
                    : (0 < m ? m * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) +
                      a[f].lineCoordinates.x1)))
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
                ...
                d[f]._labels &&
                  ...
                  (m =
                    d[f]._labels[d[f]._labels.length - ('dateTime' === d[f].valueType ? 2 : 1)]
                      .position),
                  (m = d[f].getApparentDifference(d[f].viewportMinimum, m)),
                  (E = d[f].logarithmic
                    ? (1 < m
                        ? (Math.log(m) / d[f].conversionParameters.lnLogarithmBase) *
                          Math.abs(d[f].conversionParameters.pixelPerUnit)
                        : 0) + d[f].lineCoordinates.x1
                    : (0 < m ? m * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) +
                      d[f].lineCoordinates.x1))
          for (f = 0; f < n.length; f++)
            'axisY' === n[f].type &&
              (n[f].calculateValueToPixelConversionParameters(), n[f].calculateBreaksSizeInValues())
          if (0 < v) {
            if (a && 0 < a.length)
        ...
        for (N = []; 4 > v; ) {
          ...
          if (a && 0 < a.length)
            for (F = [], f = U = 0; f < a.length; f++)
              F.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateWidth() : 0)),
                (U += F[f]),
                (e += a[f] && !p.isNavigator ? a[f].margin : 0)
          ...
          if (d && 0 < d.length)
            for (z = [], f = V = 0; f < d.length; f++)
              z.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateWidth() : 0)),
                (V += z[f]),
                (W += d[f] ? d[f].margin : 0)
          ...
          if (b && 0 < b.length)
            for (f = 0; f < b.length; f++)
              (b[f].lineCoordinates = {}),
                ...
                (k = Math.round(g.x2 - V - W > p.width - 10 ? p.width - 10 : g.x2 - V - W)),
                b[f].labelAutoFit &&
                  !u(C) &&
                  (0 < !a.length &&
                    (m =
                      0 > b[f].labelAngle
                        ...
                        : m),
                  0 < !d.length &&
                    (k = 0 < b[f].labelAngle ? k - x / 2 : 0 === b[f].labelAngle ? k - x / 2 : k)),
                (b[f].lineCoordinates.x1 = m),
                (b[f].lineCoordinates.x2 = k),
                (b[f].lineCoordinates.width = Math.abs(k - m)),
                b[f].title &&
                  (b[f]._titleTextBlock.maxWidth =
                  ...
                  (0 < !a.length &&
                    (m =
                      0 < c[f].labelAngle
                        ...
                        : m),
                  0 < !d.length && (k -= y / 2)),
                (c[f].lineCoordinates.x1 = m),
                (c[f].lineCoordinates.x2 = k),
                (c[f].lineCoordinates.width = Math.abs(k - m)),
                c[f].title &&
                  (c[f]._titleTextBlock.maxWidth =
          ...
          if (c && 0 < c.length)
            for (A = [], f = R = 0; f < c.length; f++)
              A.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)),
                (R += A[f]),
                ($ += c[f].margin)
          ...
          if (b && 0 < b.length)
            for (f = 0; f < b.length; f++)
              0 < b[f]._labels.length &&
                ((h = b[f]._labels[0]),
                (l = b[f]._labels[b[f]._labels.length - 1]),
                (C =
                  h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                  (h.textBlock.height - l.textBlock.fontSize / 2) *
                    Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
          ...
          if (c && 0 < c.length)
            for (f = 0; f < c.length; f++)
              c[f] &&
                ...
                ((h = c[f]._labels[0]),
                (l = c[f]._labels[c[f]._labels.length - 1]),
                (D =
                  h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                  (h.textBlock.height - l.textBlock.fontSize / 2) *
                    Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
          ...
          if (b && 0 < b.length)
            for (f = b.length - 1; 0 <= f; f--)
              (l = Math.round(g.y2)),
                (h = Math.round(g.y2 > b[f].chart.height - 10 ? b[f].chart.height - 10 : g.y2)),
                (b[f].lineCoordinates.y1 = l - (q[f] + b[f].margin + X)),
                (b[f].lineCoordinates.y2 = l - (q[f] + b[f].margin + X)),
                (b[f].bounds = {
                  x1: m,
          ...
          if (c && 0 < c.length)
            for (f = c.length - 1; 0 <= f; f--)
              c[f] &&
                ((l = Math.round(g.y1)),
                (h = Math.round(g.y1 + (A[f] + c[f].margin + G))),
                (c[f].lineCoordinates.y1 = h),
                (c[f].lineCoordinates.y2 = h),
                (c[f].bounds = {
                  x1: m,
                  y1: l + (c[f].margin + G),
                  x2: k,
                  ...
                  b[K] &&
                    ...
                    ((k =
                      0 > b[K].labelAngle
                        ...
                        ? Math.max(k, C / 2)
                        : k),
                    (m = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? k - U : m))
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] && c[K].labelAutoFit && ((k = c[K].lineCoordinates.x1), (m = k - U))
              a[f].lineCoordinates = { x1: k - O, y1: l, x2: k - O, y2: h, height: Math.abs(h - l) }
              a[f].bounds = { x1: k - (F[f] + O), y1: l, x2: k, y2: h, width: k - m, height: h - l }
              a[f].title &&
                (a[f]._titleTextBlock.maxWidth =
          ...
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++) {
              K =
                d[f]._labels && 0 < d[f]._labels.length ? d[f]._labels[0].textBlock.fontSize / 2 : 0
              m = Math.round(g.x1 - e)
              l =
                c && 0 < c.length
                  ? Math.round(
                  ...
                  b[K] &&
                    ...
                    ((k =
                      0 > b[K].labelAngle
                        ...
                        ? Math.max(k, C / 2)
                        : k),
                    (m = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? k - V : m))
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] && c[K].labelAutoFit && ((k = c[K].lineCoordinates.x2), (m = k - V))
              d[f].lineCoordinates = { x1: k + Q, y1: l, x2: k + Q, y2: h, height: Math.abs(h - l) }
              d[f].bounds = { x1: m, y1: l, x2: k + z[f] + Q, y2: h, width: k - m, height: h - l }
              d[f].title &&
                (d[f]._titleTextBlock.maxWidth =
    ...
    z.prototype.calculateBreaksSizeInValues = function() {
      for (
        ...
        (e = c || !u(d[g].options.spacing)),
          (d[g].spacing = I(d[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
          ...
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              var b = [],
                ...
                m,
                l = this.viewportMaximum,
                k = this.lineCoordinates.width / Math.log(this.range),
              ...
              q.position > this.viewportMaximum ||
                !(h === this._labels.length - 1 || m < (Math.log(l / q.position) * k) / e) ||
                (b.push(q),
                (l = q.position),
                (m =
          ...
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              var b = [],
                p,
                l = this.viewportMaximum,
                k = this.lineCoordinates.height / Math.log(this.range),
                h = this._labels.length - 1;
              0 <= h;
              h--
            ) {
              ...
              if (q.position < this.viewportMinimum) break
              q.position > this.viewportMaximum ||
                !(h === this._labels.length - 1 || p < Math.log(l / q.position) * k) ||
                (b.push(q),
                (l = q.position),
                (p =
    ...
    z.prototype.renderStripLinesOfThicknessType = function(a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          var d = this, b, c = 0, e = 0, g = !1, m = !1, l = [], k = [], m = !1, c = 0;
            ...
            if ('outside' === b.stripLine.labelPlacement)
              if (
                (h &&
                  ...
                  'pixel' === h._thicknessType && (this.ctx.lineWidth = h.thickness)),
    ...
    z.prototype.createMask = function() {
      if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
        ...
        r
          ? ((this.maskCanvas = ta(this.chart.width, this.chart.height)),
          ...
          if (this.scaleBreaks && !u(this.scaleBreaks.firstBreakIndex))
            if (u(this.scaleBreaks.lastBreakIndex))
              ...
              for (
                ...
                d.moveTo(e, m),
                  d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + b, m),
        ...
        if (this.scaleBreaks && !u(this.scaleBreaks.firstBreakIndex))
          if (u(this.scaleBreaks.lastBreakIndex))
            ...
            for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
              d.moveTo(m, e),
                d.lineTo(m, this.scaleBreaks._appliedBreaks[l].startPixel + c),
          ...
          a > e[g].endValue ||
            (a <= e[g].startValue && d >= e[g].endValue
              ...
              : !c &&
                ...
                (b =
                  a *
                  Math.pow(e[g].size, Math.log(d / a) / Math.log(e[g].endValue / e[g].startValue))))
      } else
    ...
    z.prototype.calculateAxisParameters = function() {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters()
        ...
        if ('axisX' === this.type && b) {
          ...
          this.interval =
            this.options && 0 < this.options.interval
              ...
              : z.getNiceNumber(c / (a - 1), !0)
          if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            this.viewportMinimum =
              'axisX' === this.type ? e - m / 2 : Math.floor(e / this.interval) * this.interval
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            this.viewportMaximum =
              'axisX' === this.type ? g + m / 2 : Math.ceil(g / this.interval) * this.interval
        ...
        this.valueFormatString ||
          (this.valueFormatString = z.generateValueFormatString(this.range, 2))
      }
    }
    z.prototype.calculateLogarithmicAxisParameters = function() {
      ...
      if (this.scaleBreaks)
        for (m = 0; m < this.scaleBreaks._appliedBreaks.length; m++)
          if (
            ((!u(this.sessionVariables.newViewportMinimum) &&
              this.sessionVariables.newViewportMinimum >=
                this.scaleBreaks._appliedBreaks[m].startValue) ||
              (!u(this.options.minimum) &&
                this.options.minimum >= this.scaleBreaks._appliedBreaks[m].startValue) ||
              (!u(this.options.viewportMinimum) &&
                this.viewportMinimum >= this.scaleBreaks._appliedBreaks[m].startValue)) &&
            ((!u(this.sessionVariables.newViewportMaximum) &&
              this.sessionVariables.newViewportMaximum <=
                this.scaleBreaks._appliedBreaks[m].endValue) ||
              (!u(this.options.maximum) &&
                this.options.maximum <= this.scaleBreaks._appliedBreaks[m].endValue) ||
              (!u(this.options.viewportMaximum) &&
                this.viewportMaximum <= this.scaleBreaks._appliedBreaks[m].endValue))
          ) {
      ...
      this.options && 0 < this.options.interval
        ...
        : ((this.interval = z.getNiceExponent(Math.log(m) / d / (a - 1), !0)),
          (b = z.getNiceNumber(l / (a - 1), !0)))
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          'axisX' === this.type
            ? c / Math.sqrt(g)
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          'undefined' === typeof this.options.interval &&
          ((this.interval = z.getNiceExponent(Math.ceil(Math.log(m) / d) / (a - 1))),
          (b = z.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))))
      if (null === this.minimum || null === this.maximum)
        'axisX' === this.type
          ...
          : 'axisY' === this.type &&
            ...
            isFinite(c) || isFinite(e)
              ? 1 === c && 1 === e
                ...
                : 1 === e / c
                ? ((m = Math.pow(this.logarithmBase, this.interval)), (e *= m), (c /= m))
                : c > e
                ? ((m = Math.min(0.01 * (c / e), 5)), 1 <= e ? (c = e / m) : (e = c * m))
                : ((m = Math.min(
                    (e / c) * Math.pow(this.logarithmBase, 0.01),
                    Math.pow(this.logarithmBase, 0.04),
                  )),
      ...
      if (
        ...
        if (2 < d) for (m = 0; m < d - 2; m++) this.valueFormatString += '#'
      }
    }
    ...
    L.prototype.createUserOptions = function(a) {
      if ('undefined' !== typeof a || this.options._isPlaceholder) {
        ...
        this.options._isPlaceholder ||
          (Fa(this.parent[this.optionsName]),
        ...
        if (
          ...
          if (
            ...
            if ('zigzag' === this.type) {
              ...
              p = (l - h) / a / 2
              for (n = 0; n < p; n++)
                this.ctx.lineTo(k, h), (k += 2 * g * a), (h += 2 * a), (g *= -1)
              this.ctx.lineTo(k, h)
              k += m - c
              for (n = 0; n < p + 1; n++)
                this.ctx.lineTo(k, h), (k += 2 * g * a), (h -= 2 * a), (g *= -1)
          ...
          if (
            ...
            (l = 1 === q % 2 ? (c.y << 0) + 0.5 : c.y << 0),
            'left' === this.scaleBreaks.parent._position
              ? ((c = this.chart.plotArea.x1), (m = (this.chart.plotArea.x2 + q / 2 + 0.5) << 0))
              : ((c = this.chart.plotArea.x2),
                (m = (this.chart.plotArea.x1 - q / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: c, y1: e - q / 2, x2: m, y2: l + q / 2 }),
            this.ctx.moveTo(c, e),
            'straight' === this.type ||
              ('left' === this.scaleBreaks.parent._position && 0 >= a) ||
              ('right' === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(m, e), this.ctx.lineTo(m, l), this.ctx.lineTo(c, l)
          else if ('wavy' === this.type) {
            k = c
            h = e
            g = 0.5
            ...
            h += l - e
            for (n = 0; n < p + 1; n++)
              this.ctx.lineTo(k, h), (h += 2 * g * a), (k -= 2 * a), (g *= -1)
      ...
      if (0 < d) {
        ...
        if ('bottom' === this.parent._position || 'top' === this.parent._position)
          (e = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            (m = this.chart.plotArea.y1),
            (l = this.chart.plotArea.y2),
            (this.bounds = { x1: e - d / 2, y1: m, x2: g + d / 2, y2: l })
        else if ('left' === this.parent._position || 'right' === this.parent._position)
          (m = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (g = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: m - d / 2, x2: g, y2: l + d / 2 })
        this.ctx.moveTo(e, m)
        this.ctx.lineTo(g, l)
        this.ctx.stroke()
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          for (var r = 0; r < this.parent.dataSeries.length; r++)
            (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) &&
              0 <= f.index &&
          ...
          if ('rangeBar' === m[0].dataSeries.type || 'error' === m[0].dataSeries.type)
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[0])),
                v = 0,
                n = 0;
              n < m.length;
              n++
              ...
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
                for (k = 0; k < m[n].dataPoint.y.length; k++)
                  (v = Math.abs(a - this.parent.convertValueToPixel(m[n].dataPoint.y[k]))),
                    v < f && ((f = v), (r = n))
              else
                (v = Math.abs(a - this.parent.convertValueToPixel(m[n].dataPoint.y))),
                  v < f && ((f = v), (r = n))
          else if ('stackedBar' === m[0].dataSeries.type)
            for (
              var f = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                D = (v = 0),
                n = (r = 0);
              n < m.length;
              n++
              ...
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
                ...
                (D += m[n].dataPoint.y),
                  (v = Math.abs(a - this.parent.convertValueToPixel(D))),
                  v < f && ((f = v), (r = n))
            ...
            for (
              ...
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
                ...
                (D += m[n].dataPoint.y),
                  (t = m[n].dataPoint.x.getTime ? m[n].dataPoint.x.getTime() : m[n].dataPoint.x),
                  (t = 100 * (D / m[n].dataSeries.plotUnit.dataPointYSums[t])),
                  (v = Math.abs(a - this.parent.convertValueToPixel(t))),
                  v < f && ((f = v), (r = n))
          else
            for (
              f = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), n = r = v = 0;
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
          ...
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            b = 0
            if (
              'rangeBar' === this.parent.dataSeries[r].type ||
              'error' === this.parent.dataSeries[r].type
            ) {
              f = Math.abs(a - this.parent.convertValueToPixel(k.dataPoint.y[0]))
              for (n = v = 0; n < k.dataPoint.y.length; n++)
                (v = Math.abs(a - this.parent.convertValueToPixel(k.dataPoint.y[n]))),
                  v < f && ((f = v), (b = n))
              m =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(k.dataPoint.y[b]) << 0) + 0.5
                  : this.parent.convertValueToPixel(k.dataPoint.y[b]) << 0
              l.text = this.labelFormatter
                ...
                ? ba(k.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                : this.label
              ...
              m =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(D) << 0) + 0.5
                  : this.parent.convertValueToPixel(D) << 0
              l.text = this.labelFormatter
                ? this.labelFormatter({
                    chart: this.chart,
                    axis: this.parent.options,
                ...
                : u(this.options.label)
                ? ba(k.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                : this.label
              ...
              l.text = this.labelFormatter
                ...
                : u(this.options.label)
                ? ba(t, this.valueFormatString, this.chart._cultureInfo)
                : this.label
            } else
              (m =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(k.dataPoint.y) << 0) + 0.5
                  : this.parent.convertValueToPixel(k.dataPoint.y) << 0),
                (l.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
            ...
            this.bounds = { x1: b - h / 2, y1: e, x2: c + h / 2, y2: g }
            l.x = b - l.measureText().width / 2
            l.x + l.width > this.chart.bounds.x2
              ? (l.x = this.chart.bounds.x2 - l.width)
              : l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1)
            l.y = this.parent.lineCoordinates.y2 + l.fontSize / 2 + 2
          } else if ('left' === this.parent._position || 'right' === this.parent._position) {
            e = g = m =
              1 === p.lineWidth % 2
                ? (this.parent.convertValueToPixel(k.dataPoint.x) << 0) + 0.5
                : this.parent.convertValueToPixel(k.dataPoint.x) << 0
            b = this.chart.plotArea.x1
            c = this.chart.plotArea.x2
            this.bounds = { x1: b, y1: e - h / 2, x2: c, y2: g + h / 2 }
            t = !1
            if (this.parent.labels)
              for (
                m = Math.ceil(this.parent.interval), n = 0;
            ...
            if (t) {
              if ('axisX' === this.parent.type)
                for (
                  n = this.parent.convertPixelToValue({ y: d }), f = null, r = 0;
                  r < this.parent.dataSeries.length;
                  r++
                )
                  (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) &&
                    0 <= f.index &&
              ...
              'dateTime' === this.parent.valueType
                ? (l.text = this.labelFormatter
                    ...
                    : u(this.options.label)
                    ? Ca(k.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
                : 'number' === this.parent.valueType &&
                  (l.text = this.labelFormatter
                    ...
                    : u(this.options.label)
                    ? ba(k.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
            l.y = g + l.fontSize / 2 - l.measureText().height / 2 + 2
            l.y - l.fontSize / 2 < this.chart.bounds.y1
              ? (l.y = this.chart.bounds.y1 + l.fontSize / 2 + 2)
              : l.y + l.measureText().height - l.fontSize / 2 > this.chart.bounds.y2 &&
                (l.y = this.chart.bounds.y2 - l.measureText().height + l.fontSize / 2)
            'left' === this.parent._position
              ? (l.x = this.parent.lineCoordinates.x2 - l.measureText().width)
              : 'right' === this.parent._position && (l.x = this.parent.lineCoordinates.x2)
          }
          ...
          if (t) {
            if ('axisX' === this.parent.type)
              for (
                n = this.parent.convertPixelToValue({ x: a }), f = null, r = 0;
                r < this.parent.dataSeries.length;
                r++
              )
                (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) &&
          ...
          if (
            ...
            for (
              f = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), n = v = 0;
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
                for (k = 0; k < m[n].dataPoint.y.length; k++)
                  (v = Math.abs(d - this.parent.convertValueToPixel(m[n].dataPoint.y[k]))),
                    v < f && ((f = v), (r = n))
              else
                (v = Math.abs(d - this.parent.convertValueToPixel(m[n].dataPoint.y))),
                  v < f && ((f = v), (r = n))
          else if (
            ...
            for (
              f = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), n = D = v = 0;
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
                ...
                (D += m[n].dataPoint.y),
                  (v = Math.abs(d - this.parent.convertValueToPixel(D))),
                  v < f && ((f = v), (r = n))
          else if (
            ...
            for (
              ...
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
                ...
                (D += m[n].dataPoint.y),
                  (t = m[n].dataPoint.x.getTime ? m[n].dataPoint.x.getTime() : m[n].dataPoint.x),
                  (t = 100 * (D / m[n].dataSeries.plotUnit.dataPointYSums[t])),
                  (v = Math.abs(d - this.parent.convertValueToPixel(t))),
                  v < f && ((f = v), (r = n))
          else
            for (
              f = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), n = v = 0;
              n < m.length;
              n++
            )
              if (m[n].dataPoint.y && m[n].dataPoint.y.length)
          ...
          b = 0
          if (
            'rangeColumn' === this.parent.dataSeries[r].type ||
            ...
            for (n = v = 0; n < k.dataPoint.y.length; n++)
              (v = Math.abs(d - this.parent.convertValueToPixel(k.dataPoint.y[n]))),
                v < f && ((f = v), (b = n))
            m =
              1 === p.lineWidth % 2
                ? (this.parent.convertValueToPixel(k.dataPoint.y[b]) << 0) + 0.5
            ...
            'stackedColumn' === this.parent.dataSeries[r].type ||
            ...
            'stackedColumn100' === this.parent.dataSeries[r].type ||
              ...
              ? ((m =
                  1 === p.lineWidth % 2
                    ? (this.parent.convertValueToPixel(
                        k.dataSeries.dataPointEOs[k.index].cumulativeSum,
                      ) <<
                        0) +
                      0.5
                    : this.parent.convertValueToPixel(
        ...
        if ('bottom' === this.parent._position || 'top' === this.parent._position)
          (b = c = m = 1 === p.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (e = this.chart.plotArea.y1),
            (g = this.chart.plotArea.y2),
            (this.bounds = { x1: b - h / 2, y1: e, x2: c + h / 2, y2: g })
        else if ('left' === this.parent._position || 'right' === this.parent._position)
          (e = g = m = 1 === p.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (b = this.chart.plotArea.x1),
            (c = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: e - h / 2, x2: c, y2: g + h / 2 })
        if ('xySwapped' === this.chart.plotInfo.axisPlacement)
          if ('left' === this.parent._position || 'right' === this.parent._position) {
            ...
            l.y - l.fontSize / 2 < this.chart.bounds.y1
              ...
              : l.y + l.measureText().height - l.fontSize / 2 > this.chart.bounds.y2 &&
                (l.y = this.chart.bounds.y2 - l.measureText().height + l.fontSize / 2)
            'left' === this.parent._position
              ? (l.x = this.parent.lineCoordinates.x1 - l.measureText().width)
              : 'right' === this.parent._position && (l.x = this.parent.lineCoordinates.x2)
          } else {
            if ('bottom' === this.parent._position || 'top' === this.parent._position)
              (l.text = this.labelFormatter
    ...
    $.prototype._updateToolTip = function(a, d, b) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && 'none' !== this.chart.plotInfo.axisPlacement) {
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var p = 0; p < this.chart.axisX.length; p++) {
                for (
                  var k = this.chart.axisX[p].convertPixelToValue({ y: d }), h = null, c = 0;
                  c < this.chart.axisX[p].dataSeries.length;
                  c++
                )
                  (h = this.chart.axisX[p].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX[p].dataSeries[c]),
                    null !== h.dataPoint.y && l.push(h))
                h = null
              }
            if (this.chart.axisX2)
              for (p = 0; p < this.chart.axisX2.length; p++) {
                k = this.chart.axisX2[p].convertPixelToValue({ y: d })
                h = null
                for (c = 0; c < this.chart.axisX2[p].dataSeries.length; c++)
                  (h = this.chart.axisX2[p].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX2[p].dataSeries[c]),
                    null !== h.dataPoint.y && l.push(h))
                h = null
              }
          } else {
            ...
            if (this.chart.axisX)
              for (p = 0; p < this.chart.axisX.length; p++)
                for (
                  k = this.chart.axisX[p].convertPixelToValue({ x: a }), h = null, c = 0;
                  c < this.chart.axisX[p].dataSeries.length;
                  c++
                )
                  (h = this.chart.axisX[p].dataSeries[c].getDataPointAtX(k, b)) &&
            ...
            if (this.chart.axisX2)
              for (p = 0; p < this.chart.axisX2.length; p++)
                for (
                  k = this.chart.axisX2[p].convertPixelToValue({ x: a }), h = null, c = 0;
                  c < this.chart.axisX2[p].dataSeries.length;
                  c++
                )
                  (h = this.chart.axisX2[p].dataSeries[c].getDataPointAtX(k, b)) &&
                    0 <= h.index &&
          ...
          if ((h = this.chart.getDataPointAtXY(a, d, b)))
            (this.currentDataPointIndex = h.dataPointIndex),
              (this.currentSeriesIndex = h.dataSeries.index)
          else if (r)
            if (
              ((h = ab(a, d, this.chart._eventManager.ghostCtx)),
              0 < h && 'undefined' !== typeof this.chart._eventManager.objectMap[h])
            ) {
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              (c = e.dataPoints[this.currentDataPointIndex]),
                ...
                (h.distance = Math.abs(c.x - k)),
                'waterfall' === e.type &&
                  ((h.cumulativeSumYStartValue =
                    e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue),
                  (h.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum))
            else {
              if (
                !this.enabled ||
                ('line' !== e.type &&
            ...
            if (!u(h.dataPoint.y))
              if (h.dataSeries.axisY)
                if (0 < h.dataPoint.y.length) {
                  for (c = b = 0; c < h.dataPoint.y.length; c++)
                    h.dataPoint.y[c] < h.dataSeries.axisY.viewportMinimum
                      ? b--
                      : h.dataPoint.y[c] > h.dataSeries.axisY.viewportMaximum && b++
                  b < h.dataPoint.y.length && b > -h.dataPoint.y.length && g.push(h)
                } else
                  'column' === e.type || 'bar' === e.type
                    ? 0 > h.dataPoint.y
                      ? 0 > h.dataSeries.axisY.viewportMinimum &&
                        h.dataSeries.axisY.viewportMaximum >= h.dataPoint.y &&
                        g.push(h)
                      : h.dataSeries.axisY.viewportMinimum <= h.dataPoint.y &&
                        0 <= h.dataSeries.axisY.viewportMaximum &&
                        g.push(h)
                    : 'bubble' === e.type
                    ? ((b = this.chart._eventManager.objectMap[e.dataPointIds[h.index]].size / 2),
                      h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum - b &&
                        h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum + b &&
                        g.push(h))
                    : 'waterfall' === e.type
                    ? ((b = 0),
                      h.cumulativeSumYStartValue < h.dataSeries.axisY.viewportMinimum
                        ? b--
                        : h.cumulativeSumYStartValue > h.dataSeries.axisY.viewportMaximum && b++,
                      h.cumulativeSum < h.dataSeries.axisY.viewportMinimum
                        ? b--
                        : h.cumulativeSum > h.dataSeries.axisY.viewportMaximum && b++,
                      2 > b && -2 < b && g.push(h))
                    : (0 <= h.dataSeries.type.indexOf('100') ||
                        'stackedColumn' === e.type ||
                        'stackedBar' === e.type ||
                        (h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum &&
                          h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum)) &&
                      g.push(h)
              else g.push(h)
          }
        }
            ...
            try {
              ;(this.contentDiv.style.background = this.backgroundColor
                ...
                (this.contentDiv.style.borderRadius =
                  this.cornerRadius || 0 === this.cornerRadius ? this.cornerRadius + 'px' : '5px'),
                (this.container.style.borderRadius = this.contentDiv.style.borderRadius),
      ...
      for (b = 0; b < a.length; b++) {
        ...
        if (
          ...
          !1 === g.highlightEnabled ||
            ...
            'rangeArea' === c.type ||
            'rangeSplineArea' === c.type
              ? ((g = c.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                ...
                'undefined' !== typeof e.y2 &&
                  ((g = c.getMarkerProperties(k, e.x1, e.y2, this.chart.overlaidCanvasCtx)),
                  (g.size = Math.max((1.5 * g.size) << 0, 10)),
                  (g.borderColor = g.borderColor || '#FFFFFF'),
                  (g.borderThickness = g.borderThickness || Math.ceil(0.1 * g.size)),
                  ia.drawMarkers([g])))
              ...
              : 'column' === c.type ||
                ...
                'rangeColumn' === c.type ||
                'waterfall' === c.type
              ? ea(d, e.x1, e.y1, e.x2, e.y2, 'white', 0, null, !1, !1, !1, !1, 0.3)
    ...
    $.prototype.getToolTipInnerHTML = function(a) {
      a = a.entries
      for (var d = null, b = null, c = null, e = 0, g = '', k = !0, l = 0; l < a.length; l++)
      ...
      if (k && ((this.content && 'function' === typeof this.content) || this.contentFormatter))
        ...
        for (var p = null, h = '', l = 0; l < a.length; l++)
          (b = a[l].dataSeries),
            (c = a[l].dataPoint),
            (e = a[l].index),
            (g = ''),
                ...
                : this.chart.axisX2 &&
                  ...
                  (h +=
                    'undefined' !== typeof this.chart.axisX2[0].labels[c.x]
                      ...
                      : '{x}'),
              (h += '</br>'),
              (h = this.chart.replaceKeywordsWithValue(h, c, b, e))),
    ...
    var M = {
        ...
        xClipAnimation: function(a, d) {
          if (0 !== a) {
            ...
            b.save()
            0 < a &&
              b.drawImage(c, 0, 0, c.width * a, c.height, 0, 0, (c.width * a) / W, c.height / W)
            b.restore()
          }
        },
